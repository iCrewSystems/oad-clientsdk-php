...
class WEATHERApi
{
    ...
    /**
     * Operation weatherMetarRadiusGet
     *
     ...
     * @return \Swagger\Client\Model\METAR[]
     */
    public function weatherMetarRadiusGet($lat, $lon, $radius)
    {
        list($response) = $this->weatherMetarRadiusGetWithHttpInfo($lat, $lon, $radius);
        return $response;
    }

    /**
     * Operation weatherMetarRadiusGetWithHttpInfo
     *
     * METAR by Station in Radius from Centerpoint
     *
     * @param string $lat Latitude of centerpoint (Decimal Degrees) (required)
     ...
     * @param string $radius Radius to search within (Statute Miles) (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\METAR[], HTTP status code, HTTP response headers (array of strings)
     */
    public function weatherMetarRadiusGetWithHttpInfo($lat, $lon, $radius)
    {
        // verify the required parameter 'lat' is set
        if ($lat === null) {
            throw new \InvalidArgumentException('Missing the required parameter $lat when calling weatherMetarRadiusGet');
        }
        // verify the required parameter 'lon' is set
        if ($lon === null) {
            throw new \InvalidArgumentException('Missing the required parameter $lon when calling weatherMetarRadiusGet');
        }
        // verify the required parameter 'radius' is set
        if ($radius === null) {
            throw new \InvalidArgumentException('Missing the required parameter $radius when calling weatherMetarRadiusGet');
        }
        // parse inputs
        $resourcePath = "/weather/metar/radius";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\METAR[]',
                '/weather/metar/radius'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\METAR[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\METAR[]', $e->getResponseHeaders());
    ...
    /**
     * Operation weatherMetarRectangleGet
     *
     ...
     * @return \Swagger\Client\Model\METAR[]
     */
    public function weatherMetarRectangleGet($minlat, $maxlat, $minlon, $maxlon)
    {
        list($response) = $this->weatherMetarRectangleGetWithHttpInfo($minlat, $maxlat, $minlon, $maxlon);
        return $response;
    }

    /**
     * Operation weatherMetarRectangleGetWithHttpInfo
     *
     * METAR by Station in Rectangular Zone
     *
     * @param string $minlat Minimum latitude to make rectangular (Decimal Degrees) (required)
     ...
     * @return array of \Swagger\Client\Model\METAR[], HTTP status code, HTTP response headers (array of strings)
     */
    public function weatherMetarRectangleGetWithHttpInfo($minlat, $maxlat, $minlon, $maxlon)
    {
        // verify the required parameter 'minlat' is set
        if ($minlat === null) {
            throw new \InvalidArgumentException('Missing the required parameter $minlat when calling weatherMetarRectangleGet');
        }
        // verify the required parameter 'maxlat' is set
        if ($maxlat === null) {
            throw new \InvalidArgumentException('Missing the required parameter $maxlat when calling weatherMetarRectangleGet');
        }
        // verify the required parameter 'minlon' is set
        if ($minlon === null) {
            throw new \InvalidArgumentException('Missing the required parameter $minlon when calling weatherMetarRectangleGet');
        }
        // verify the required parameter 'maxlon' is set
        if ($maxlon === null) {
            throw new \InvalidArgumentException('Missing the required parameter $maxlon when calling weatherMetarRectangleGet');
        }
        // parse inputs
        $resourcePath = "/weather/metar/rectangle";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    /**
     * Operation weatherMetarStationGet
     *
     * METAR by Station
     *
     ...
     * @return \Swagger\Client\Model\METAR[]
     */
    public function weatherMetarStationGet($icao)
    {
        list($response) = $this->weatherMetarStationGetWithHttpInfo($icao);
        return $response;
    }

    /**
     * Operation weatherMetarStationGetWithHttpInfo
     *
     * METAR by Station
     *
     * @param string $icao Station Identifier (Weather Station or Airport) (required)
     ...
     * @return array of \Swagger\Client\Model\METAR[], HTTP status code, HTTP response headers (array of strings)
     */
    public function weatherMetarStationGetWithHttpInfo($icao)
    {
        // verify the required parameter 'icao' is set
        if ($icao === null) {
            throw new \InvalidArgumentException('Missing the required parameter $icao when calling weatherMetarStationGet');
        }
        // parse inputs
        $resourcePath = "/weather/metar/station";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
